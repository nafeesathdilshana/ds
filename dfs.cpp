...
int main()
{
    int cost[10][10], i, j, k, n, e, top, v, stk[10], visit[10], visited[10];      //variable declaration
    ...
    cout << v << " ";
    visited[v] = 1;                                                    //As we start with the vertex v, marking it visited to avoid visiting again
    k = 1;
